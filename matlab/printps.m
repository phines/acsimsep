...
for i = 1:nbr
    ...
    over = ' ';
    if any(abs(Sft)>rateA), over = '*'; end
    fprintf('%3d %5d %5d %3d %6d %8.2f %8.2f %8.2f %8.2f %8.2f %s %8.2f %8.2f\n',...
        i, from, to, ps.branch(i,C.br.status), ps.branch(i,C.br.contg_st), Sft, rateA, over, If, It);
end
