function [ps, converged, g_x] = acpf(ps,PartFact,opt)
            ...
            while true % exit from this loop if power flow converges
                ...
                if converged
                    ...
                    if ~opt.pf.CascadeControl
                        ...
                        [beta, beta_S, xm, alaki] = find_sens_fact(mismatch,x0,Sd_bus_sub,pq_sub,ref_sub,opt.pf.PartFactFlag,verbose);
                        converged = false;
                        g_x = alaki;
                        return
                        ...
                        [ps, is_black] = shed_load(ps,busi_sub,beta,beta_S,verbose);
                        if is_black
                            break
                        end
